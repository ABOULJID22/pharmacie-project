...
const [settinginfos, setSettinginfo] = useState(null);

useEffect(() => {
  fetch("/api/settinginfos")
    .then((response) => response.json())
    .then((data) => {
      console.log("REÇU :", data);
      setSettinginfo(data);
    })
    .catch((error) => console.error("Error fetching setting info:", error));
}, []);
  ...
  <div className="container mx-auto flex flex-col md:flex-row items-center justify-between py-12 md:py-20 px-4 md:px-8 relative z-10 w-full">
    ...
    >
      <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold leading-tight mb-2 text-white">
        Bienvenue sur votre plateforme <span className="text-[#ffe082]">Offitrade</span>
      </h1>
...
{/* about  */}
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 leading-tight">
              Notre Histoire d'Excellence chez <span className="text-blue-600">Offitrade</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row mt-8 gap-6">
              <div className="flex items-center space-x-4">
                <svg className="w-12 h-12 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2"
              ...
              <div className="flex items-center space-x-4">
                <svg className="w-12 h-12 text-green-500" fill="none" stroke="currentColor" strokeWidth="2"
                  viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <section
      className="bg-gradient-to-r from-[#3a5a8f] to-[#a1b6d8] text-white min-h-screen py-12"
      id="services"
    >
      <div className=" mx-auto px-6 lg:px-20">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-12">
          {/* Text Section */}
          <motion.div
            className="lg:w-1/2 leading-relaxed"
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          >
            <p className="mb-4">
              En début d'année, les pharmacies cherchent à maximiser les remises
              et offres, mais après cette période intense, la gestion des mises
              en avant devient complexe pour les équipes. Offitrade propose une
              solution clé en main pour simplifier l'organisation, la
              planification et le suivi des paiements.
            </p>
            <p className="mb-6">
              L'accompagnement commence par des audits personnalisés, suivi par
              un calendrier trade annuel. La mise en avant des produits en Tête
              de Gondole (TG) est planifiée sur six mois avec rappels et
              objectifs. Des rendez-vous trimestriels garantissent le suivi des
              paiements.
            </p>

            {/* Feature: Gain de Temps */}
            <motion.div
            ...
            >
              ...
              <h3 className="text-2xl font-semibold">Gain de temps</h3>
            </motion.div>

            {/* Feature: Booster le Sell Out */}
            <motion.div
              className="flex items-center mb-6"
              whileHover={{ scale: 1.05 }}
              transition={{ duration: 0.3 }}
            >
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M8.891 15.107 15.11 8.89m-5.183-.52h.01m3.089 7.254h.01..."
                />
              </svg>
              <h3 className="text-2xl font-semibold">Booster le Sell Out</h3>
            </motion.div>

            {/* Feature: Trésorerie Stabilisée */}
            <motion.div
            ...
            >
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="m7.171 12.906-2.153 6.411...Z"
                />
              </svg>
              <h3 className="text-2xl font-semibold">Trésorerie stabilisée</h3>
            </motion.div>
          </motion.div>
...
>
  <source src="/video/269264_tiny.mp4" type="video/mp4" />
    ...
    <div className="flex flex-col lg:flex-row lg:justify-between gap-8">
      ...
      <div className="lg:w-1/2">
        ...
        <div className="flex items-center mb-6">
          <svg className="w-8 h-8 text-gray-600 mr-4" fill="currentColor" viewBox="0 0 32 32">
          ...
          <div>
            ...
            <p>{settinginfos?.address || "Adresse non disponible"}</p>
          </div>
        </div>
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p>{settinginfos?.telephone || "Numéro non disponible"}</p>
          </div>
        </div>
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p>{settinginfos?.email || "Email non disponible"}</p>
          </div>
...
<section className="bg-white py-20">
  <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="space-y-6">
      ...
      {faqs.map((faq) => (
        <details key={faq.id_question} className="group border-b pb-4">
          <summary className="flex justify-between items-center cursor-pointer text-gray-900 font-medium text-lg">
...
<footer className="bg-gradient-to-r from-[#3a5a8f] to-[#a1b6d8] text-gray-300 pt-14 pb-8 mt-16">
  <div className="max-w-7xl mx-auto px-6 lg:px-8">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-gray-700 pb-10">
      ...
      {/* Brand & Description */}
  <div >
  {settinginfos && settinginfos.logo && (
  <img
   src={settinginfos?.logo ? `/storage/${settinginfos.logo}` : "/images/logo.png"}
    alt="Offitrade Logo"
    className="h-10 mb-4"
  />
)}
